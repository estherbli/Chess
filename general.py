...
class general() :
    def __init__(self):
        ...
        self.echiquier=pygame.image.load(f'{pieces.path_esther}\\echiquierabc2.png') #on charge l'echiquier ici pour n'avoir à le faire qu'une seule fois (opération plutôt lourde)
...
#page de démarrage
    ...
    def __main__(self):
        ...
        (1,4),(3,5),
        (5,4),(5,3),
        (3,5),(1,6), #cavalier blanc
        (2,5),(4,4),
        (2,4),(3,4),#reine blanche
        (5,3),(5,2),#pion noir
        (6,1),(6,2),
        (4,4),(3,2),
        (2,0),(2,6),#tour blanche
        (6,7),(4,7),#tour noire près du roi
        (1,6),(3,5),#cavalier blanc
        (4,7),(4,0),#tour noir ###
        (6,0),(7,1),#roi blanc
        (3,2),(5,1),#cavalier noir
        (3,5),(5,6), #cavalier blanc censé
        (7,7),(6,6),
        (5,6),(6,4),
        (6,6),(7,5),
        (2,6),(7,6)]
